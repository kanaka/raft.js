...
In the Raft over WebRTC implemenation each local browser is a client
...
\begin{enumerate}
    ...
    \item \emph{test/test\_chat\_propagate.js}: similar to
        ...
        propogate to every other node's state machine. The test
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item \emph{SlimerJS}: vesion 0.9.6
